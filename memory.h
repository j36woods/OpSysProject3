...
public:
	...
	virtual bool addProcess(Process* proc, unsigned start_time, unsigned& new_time, int last_defrag, int time_process_left_mem, unsigned &moved) = 0;
...
public:
	FFMemory();
	bool addProcess(Process* proc, unsigned start_time, unsigned& new_time, int last_defrag, int time_process_left_mem, unsigned &moved);
};
